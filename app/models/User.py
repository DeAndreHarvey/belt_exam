...
class User(Model):
    ...
    def create_user(self, info):
        ...
        if errors:
            ...
            create_query = "INSERT INTO users (email, name, alias, pw_hash, birth_date, created_at) VALUES (:email, :name, :alias, :pw_hash, :birth_date, NOW())"
            create_data = { 'email': info['email'],
                           'name': info['name'], 'alias':info['alias'],
                           'pw_hash': pw_hash,
